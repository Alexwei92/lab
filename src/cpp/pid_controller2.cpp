...
public:
	...
	m_serviceUpdate = n1.advertiseService("update", &Controller::update, this);
...
private:
    ...
    bool update(std_srvs::Empty::Request& req, std_srvs::Empty::Response& res)
    {
	m_pidZ.updateparam(10000.0, 0.0, 4000.0, 10000.0, 50000.0, -800.0, 800.0);
        return true;
    }
    ...
    void iteration(const ros::TimerEvent& e)
    {
        ...
        /*
                if (m_current.pose.position.z > m_startZ + 0.1 || m_thrust > 45000)
                {
                    pidReset();
...
private:
    ...
    ros::ServiceServer m_serviceUpdate;
